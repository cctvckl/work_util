...
//	}
    ...
    public String[] generateSchemaCreationScript(Dialect dialect) throws HibernateException {
        ...
        String mapJson = "{\n" +
                ...
                "  }\n" +
                "}";
//        HashMap<String, HashMap<String, String>> tableCommentMap = com.ceiec.util.CommentUtil.constructTableCommentMap();
        HashMap<String, HashMap<String, String>> tableCommentMap = JSON.parseObject(mapJson, new TypeReference<HashMap<String, HashMap<String, String>>>() {
        });
        System.out.println("tableCommentMap:" + tableCommentMap);
        ...
        while ( iter.hasNext() ) {
            ...
            HashMap<String, String> fieldCommentMap = tableCommentMap.get(table.getName().toUpperCase());

            if ( table.isPhysicalTable() ) {
                script.add(
                        table.sqlCreateStringCustomed(
                                dialect,
                                mapping,
                                defaultCatalog,
                                defaultSchema,
